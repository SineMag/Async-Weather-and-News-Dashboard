...
export function fetchWeatherAndNewsPromiseChain(): Promise<{ weather: any, news: any }> {
...
export function fetchWeatherAndNewsPromiseAll(): Promise<{ weather: any, news: any }> {
    console.log('Starting Promise.all() - fetching weather and news simultaneously...');
...
export function fetchWeatherAndNewsPromiseRace(): Promise<any> {
...
export function fetchWeatherAndNewsPromises(): Promise<{ weather: any, news: any }> {
