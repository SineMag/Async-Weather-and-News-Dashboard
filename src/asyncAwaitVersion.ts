...
export async function fetchWeatherAndNewsSequential(): Promise<{ weather: any, news: any }> {
    try {
...
export async function fetchWeatherAndNewsParallel(): Promise<{ weather: any, news: any }> {
    try {
        console.log('Fetching weather and news data in parallel (Async/Await + Promise.all)...');
...
export async function fetchWeatherAndNewsRace(): Promise<any> {
    try {
...
export async function fetchWeatherAndNewsAsync(): Promise<{ weather: any, news: any }> {
    return fetchWeatherAndNewsParallel();
}

// Error handling example with try-catch-finally
export async function fetchWithAdvancedErrorHandling(): Promise<{ weather: any, news: any } | null> {
